...
const data = [
    ...
    {
      name: 'Salt Mountain',
      description: ' #F5F5F5EFF → #D7FFFE',
      css: 'linear-gradient(135deg, #F5F5F5EFF 0%, #D7FFFE 100%)',
      height: 30,
      text: 'SDG11'
    },
    {
      name: 'New York',
      description: ' #F5F5F51eb → #ace0f9',
      css: 'linear-gradient(135deg, #F5F5F51eb 0%, #ace0f9 100%)',
      height: 30,
      text: 'SDG12'
    },
    {
